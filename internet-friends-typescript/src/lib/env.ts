...
export interface Env {
  INTERNETFRIENDS_SESSION_AUTH?: string | undefined;

  INTERNETFRIENDS_DEBUG?: boolean | undefined;
}

export const envSchema: z.ZodType<Env, z.ZodTypeDef, unknown> = z.object({
  INTERNETFRIENDS_SESSION_AUTH: z.string().optional(),

  INTERNETFRIENDS_DEBUG: z.coerce.boolean().optional(),
});
